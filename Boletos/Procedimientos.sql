...
@b int, @Idboleto int, @Nmero_asiento int, @Precio int, @Fecha datetime, @Idruta int
as
begin
...
@b int, @Idruta int, @NombreR varchar(50), @Idbus int, @Cant_asientos int, @Hora_origen1 time, @Hora_destino1 time, @Hora_origen2 time, @Hora_destino2 time, @Idpropietario int
as
begin

if @b=1
insert into Ruta values (@NombreR, @Idbus, @Cant_asientos, @Hora_origen1, @Hora_destino1, @Hora_origen2, @Hora_origen2, @Idpropietario);
...
if @b=4
update Ruta
set NombreR=@NombreR, Idbus=@Idbus, Cant_asientos=@Cant_asientos, Hora_origen1=@Hora_origen1, Hora_destino1=@Hora_destino1, 
...
if @b= 4
update Usuario
set Nombre=@Nombre, Apellido=@Apellido, Direcciòn=@Direccion, Correo=@Correo, TelefonoU=@TelefonoU
